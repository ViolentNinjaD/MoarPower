...
public class ItemHelper
{
    ...
    public static int getColor(ItemStack itemStack)
    {
        ...
        else
        {
            ...
            return displayTagCompound == null ? Integer.parseInt(Colours.PURE_WHITE, 16) : displayTagCompound.hasKey("color") ? displayTagCompound.getInteger("color") : Integer.parseInt(Colours.PURE_WHITE, 16);
        }
    }
